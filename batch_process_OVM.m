...
% date_vec = (datenum(2001, 5, 16) : 1 : datenum(2001, 12, 31))';
date_vec = (datenum(2001, 5, 16) : 1 : datenum(2010, 09, 04))';
outpath = ['G:\PROCESSED\CHAMP\OVM\', Pc_class, '\'];
...
for i = 1:length(date_vec)
    ...
    if exist('Magnetar', 'var');
        ...
        if (s > 1000) && (size(Magnetar.R{1}, 2) == 5)
            ...
            save([outpath, 'CHAMP_OVM_', Pc_class, '_', datestr(ti, 'yyyy-mm-dd'),...
                '.mat'], 'Magnetar');
        end
...
% Latitude = [-90, 90];
% 
% date_vec = (datenum(2014, 6, 15) : 1 : datenum(2014, 10, 1))';
% 
% for i = 1:length(date_vec)
%     
%     ti = date_vec(i); 
